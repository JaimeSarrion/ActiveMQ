...
namespace Oficina2
{
    class Program
    {
        ...
        public static string topicOfi1Temp = "TempOfi2";
        public static string topicOfi1Lum = "LumOfi2";
        public static string serviceOfi1Lum = "serviceLumOfi2";
        public static string serviceOfi1Temp = "serviceTempOfi2";
